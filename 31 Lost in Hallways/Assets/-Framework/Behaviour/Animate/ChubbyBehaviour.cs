...
public class ChubbyBehaviour : TransformBehaviour
{
...
//	private bool					isEnable			= false;
	...
	private DefaultScaleBehaviour	defaultScale		= null;
	public END_ACTION nEndAction = END_ACTION.NOTHING;
	...
	protected override void Awake()
	{
		if( m_transform==null )
		{
			...
			defaultScale	= GetComponent(typeof(DefaultScaleBehaviour)) as DefaultScaleBehaviour;
