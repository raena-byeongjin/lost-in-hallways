...
public class objSwing : MonoBehaviour
{
	...
	public class tagData
	{
		...
		public Vector2		Swing			= new Vector2( (1), (1) );
	...
	void Update()
	{
		...
		// -
		//---------------------------------------------------------------------------------------------------------------------------
		(Transform().localEulerAngles)		= (data.Rotation) + new Vector3( Mathf.Cos(fCycle)*(data.Swing.x)*(data.fade), Mathf.Sin(fCycle)*(data.Swing.y)*(data.fade) );
